...
<body>
    ...
    <div class="navbar">
        <a href="employeehome">Employee Home</a>
        <a href="empprofile">Employee Profile</a>
        <a href="empcontactus">Employee Contact Us</a>
        <a href="updateempprofile">Update Employee Profile</a>
        <a href="viewempsbydept">View Co-Dept Workers</a>
        <a href="emplogout">Employee Logout</a>
    </div>
</body>
</html>